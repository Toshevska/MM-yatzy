  ...
  for (var i_sim = 0; i_sim < num_sims; i_sim++) { 
    ...
    for (var i_cat = 0; i_cat < cat_scores.length; i_cat++) { 
      ...
      for (var rolls_left = 2; rolls_left >= 0; rolls_left--) { 
        ...
        //console.log("Alejandro_feature_vector_first_half", feature_vector_first_half);
      ...
      cat_scores[ ind_cat ] = feature_vector[ ind_cat + 32 ]
      score_sum = score_sum + feature_vector[ ind_cat + 32 ]
